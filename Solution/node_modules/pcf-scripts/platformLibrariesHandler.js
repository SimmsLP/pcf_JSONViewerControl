...
class PlatformLibrariesHandler {
    ...
    getLatestVersions(control) {
        ...
        if (specifiedLibraries["react"]) {
            map["react"] = this.getSupportedVersion("react", specifiedLibraries["react"])?.libAlias;
            if (!map["react"]) {
            ...
            if ((_featureManager ?? (_featureManager = new featureManager_1.FeatureManager())).isFeatureEnabled("pcfOldReactNamespace")) {
                map["react"] = "React";
            }
        }
        return extObj;
